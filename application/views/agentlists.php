    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-body">
                ...
                <table id="mainTable"
                       data-toggle="table"
                       data-url="/AgentAdmin/getsAgentList/<?= $paid ?>"
                    ...
                    <tr>
                        ...
                        <th data-field="PAID" data-align="center" > 上级代理商ID</th> 
                        <th data-field="ROOMCARD"  data-align="center"> 房卡余额</th>
                        <th data-field="GOLD"  data-align="center"  > 元宝余额</th> 
                        <th data-field="GAMERNUM"  data-align="center" data-formatter="getLinkData" > 绑定玩家数</th>
                        <th data-field="GAMENUM"  data-align="center"> 绑定玩家组局数</th>
                        <th data-field="CTIME"  data-align="center">账号开通时间</th>
                        <th data-field="SOURCE"  data-align="center" data-formatter="getCtype"  >开通方式</th>
...
<script type="text/javascript">
    ...
    function getLinkData(value, row, index) {
        var url = "/AgentAdmin/gamerList/"+row["AID"];
