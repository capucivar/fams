<!--<link rel="stylesheet" href="/static/js/jweixin-1.0.0.js">-->
...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="col-sm-6">
            <form id="mForm" role="form" class="form-horizontal" method="post" action="/Roomcard2C/go"> 
...
<!--<button type="button" name="onMenuShareTimeline" id="onMenuShareTimeline" onclick="share()" class="btn btn-primary btn-lg ba-center" >
    测试分享给朋友
</button> --> 
